...
const string strMessageMagic = "Mentos Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (250 * CENT); // 200% Forever
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Mentos", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Ment is born on 31-03-2019.";
        CTransaction txNew;
        txNew.nTime = 1553996102;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1553996102;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1334500 : 1334500;
        ...
        assert(block.hashMerkleRoot == uint256("0xf2daf6ad68c2e3a88bb98d871f5e21b5e02c69b8bb40ae86bb377bdb5094158d"));
